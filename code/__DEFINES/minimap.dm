...
#define MINIMAP_FLAG_BS (1<<0)
#define MINIMAP_FLAG_NCR (1<<1)
#define MINIMAP_FLAG_LEGION (1<<2)
#define MINIMAP_FLAG_NONEFRACTION (1<<3)
#define MINIMAP_FLAG_ENEMYMOBS (1<<4)
